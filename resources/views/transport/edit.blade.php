        ...
        <div class="row w-auto flex-column">
            <div class="col-3 m-auto">
                <div class="form-group">
                    ...
                    <input type="text" name="type" value="{{ $transport->type }}" class="form-control">
                </div>
            </div>
            <div class="col-3 m-auto">
                <div class="form-group">
                    <strong>Вартість проїзду:</strong>
                    <input type="number" min="0" name="tariff"  value="{{ $transport->tariff }}" class="form-control" placeholder="5">
                </div>
            </div>
